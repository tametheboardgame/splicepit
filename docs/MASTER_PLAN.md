...
Land, Water and Air pits require appropriate biological capability. Players may diversify or specialise rather than being forced to maintain one of each.
...
Detailed story beyond this structure remains authored separately.
...
R0.3 irreversible uncertain splicing + knowledge/testing
  ↓
R0.4 capability-driven turn combat + Land/Water/Air
  ↓
...
Every implementation WP should define:

1. dependencies
2. scope/out-of-scope
3. affected systems/files
4. schema/save impact
5. automated tests
6. browser acceptance path where applicable
7. explicit exit criteria
8. open decisions revealed by the work

...
R0.1 is complete and merged. The forward plan contains **75 implementation work packages** from R0.2 through release candidate.
...
**Goal:** prove turn-based capability combat where preparation and tactical play both matter, while establishing a prototype presentation direction that is worth expanding.
...
16. **WP0.4C — Visual Direction Pivot and Presentation Pass** — fixes combat clipping/spacing and pivots the prototype away from dark box-heavy UI towards a bright cartoon/pastoral surface with grotesque biotech and body-horror contrast.
17. **WP0.4D — Training and Individual Skill Expression**
18. **WP0.4E — Status, Injury, Recovery and Pit Danger**
19. **WP0.4F — Land, Water and Air Functional Eligibility** — functional flight/swimming required; multi-environment qualification allowed.
20. **WP0.4G — Multi-Creature and Special-Bout Architecture**
21. **WP0.4H — Opponent Construction and AI**
22. **WP0.4I — Balance Harness and Combat Playtest Lock**

**WP0.4C presentation gate:** all combat controls are fully visible/clickable on common desktop viewports; title, lab/world, splice and combat screens receive a coherent first-pass colourful/cartoonish visual treatment with deliberately unsettling splice-biotech details; UI framing is less dominated by large dark boxes; existing gameplay remains functional. Final production art metrics/assets remain WP0.6A–E.

**Release gate:** biology determines available actions; environment eligibility is functional; combat is tactically readable; no obvious universal build/action dominates; the prototype presentation direction is coherent enough to continue building against.
...
23. **WP0.5A — Authored World/Map Runtime**
24. **WP0.5B — Dialogue, NPC and Relationship State**
25. **WP0.5C — Quest, Story Clock and Branch-State Framework**
26. **WP0.5D — Acquisition, Inventory and Economy Framework** — Buy / Harvest / Win / Trade.
27. **WP0.5E — Test Stock, Housing and Physical Creature Handling**
28. **WP0.5F — Pit Upgrade Framework** — nine locked domains, data-driven dependencies.
29. **WP0.5G — Fit Pit Ladder, Circuits and Reward Progression Framework**
30. **WP0.5H — Integrated World Loop Prototype**
...
31. **WP0.6A — Art Direction, Tone and Content-Warning Specification**
32. **WP0.6B — Environment and Character Asset Pipeline** — locks tile/sprite/camera metrics.
33. **WP0.6C — Production Creature Phenotype Renderer**
34. **WP0.6D — UI Design System and World/Dialogue Production Pass**
35. **WP0.6E — Lab and Combat Production UI**
36. **WP0.6F — Audio, Settings, Accessibility and Localisation Runtime**
37. **WP0.6G — Asset Performance and Presentation Integration Gate**
...
38. **WP0.7A — Pre-Alpha Content Lock and Slice Manifest**
39. **WP0.7B — Opening Disaster and Emergency Starter**
40. **WP0.7C — Inherited Pit Production Location**
41. **WP0.7D — Starting Hub and Routes**
42. **WP0.7E — Authored Acquisition and Experimentation Loop**
43. **WP0.7F — First Fit Pit, Debt Pressure and Early Upgrades**
44. **WP0.7G — Save, Onboarding and End-to-End Integration**
45. **WP0.7H — Structured Pre-Alpha Playtest and Hardening**
...
46. **WP1A — Act 1 Canon and Production Content Lock**
47. **WP1B — Act 1 Geography and Environmental Content**
48. **WP1C — Act 1 NPCs, Dialogue, Relationships and Suspicion Arc**
49. **WP1D — Act 1 Base Animals, Source Packages and Biological Content Roster**
50. **WP1E — Act 1 Quests, Acquisition Economy and Optional Work**
51. **WP1F — Act 1 Fit Pit Circuit and Water/Air Introduction**
52. **WP1G — Act 1 Pit Upgrades, Training, Recovery and Creature Management**
53. **WP1H — Debt Deadline and Paid/Unpaid Act 1 Resolution**
54. **WP1I — Alpha 1 Integration, Balance, Onboarding and QA**
...
55. **WP2A — Act 2 Branch Architecture and Content Lock**
56. **WP2B — Independent/Free Act 2 Route**
57. **WP2C — Creditor-Controlled Act 2 Route**
58. **WP2D — Water, Air and Specialist Circuit Expansion**
59. **WP2E — Advanced Biology, Rare Bases and Mutation Research Content**
60. **WP2F — Advanced Pit, Training, Recovery and High-Risk Competition**
61. **WP2G — Act 2 Progression, Economy and Branch Convergence Tuning**
62. **WP2H — Alpha 2 Integration, Scale, Save and Performance QA**
...
63. **WP3A — Content Completion and Canon Audit**
64. **WP3B — Splicing, Knowledge and Biological Balance Pass**
65. **WP3C — Combat, Arena and Pit Balance Pass**
66. **WP3D — Economy, Progression and Branch-Coherence Pass**
67. **WP3E — UX, Accessibility, Controller and Localisation Beta Pass**
68. **WP3F — Browser Performance, Asset and Compatibility Beta Pass**
69. **WP3G — Full-Game Beta Regression and Feature Freeze Gate**
...
70. **WP4A — Release Feature Freeze, Defect Triage and RC Branch Discipline**
71. **WP4B — Save Compatibility, Migration and Failure Recovery Certification**
72. **WP4C — Deployment, Rollback and Browser Compatibility Certification**
73. **WP4D — Legal, Licensing, Credits, Warning and Attribution Closure**
74. **WP4E — Final Performance, Presentation and Localisation Polish**
75. **WP4F — Release Candidate Full-Game Certification**
...
- **DG-VISUAL-DIRECTION:** colourful cartoon/pastoral + grotesque biotech prototype direction — establish and human-lock the prototype direction in WP0.4C; production specification/metrics remain WP0.6A–B.
- **DG-ARENA-THRESHOLDS:** functional qualification rules — lock prototype in WP0.4F.
- **DG-INJURY-RISK:** exact Pit danger/injury/death rules — prototype WP0.4E; production tuning R1/R2/R3.

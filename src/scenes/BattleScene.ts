...
export class BattleScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.cameras.main.setBackgroundColor(PALETTE.paperDeep); this.drawPit(); addNoiseLines(this, 100, 0.06);
    ...
    addButton(this, 185, 500, 200, 'ATTACK', () => this.takeTurn('attack'), { accent: PALETTE.rust });
    addButton(this, 480, 500, 200, 'USE TRAIT', () => this.takeTurn('trait'), { accent: PALETTE.acid });
    addButton(this, 775, 500, 200, 'BRACE', () => this.takeTurn('guard'), { accent: PALETTE.moss });
    this.updateHud();
  }

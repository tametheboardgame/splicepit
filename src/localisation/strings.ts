const EN_GB = {
  ...
  'splice.eyebrow': 'SPLICE BENCH / MANUAL MODE',
  'splice.title': 'Make something viable.',
  'splice.instructions': 'Select any recovered genes. More complex combinations are less likely to hold and more likely to mutate. There is no designed combination limit; the risk curve is the constraint.',
  'splice.attempt': 'ATTEMPT SPLICE',
  'splice.return': 'RETURN TO PIT',
  'splice.cardMeta': 'SOURCE {source}  |  COMPLEXITY {complexity}',
  'splice.previewTitle': '{base} + {count} {geneWord}',
  'splice.geneSingular': 'gene',
  'splice.genePlural': 'genes',
  'splice.previewStats': 'VIABILITY       {chance}%\nCOMPLEXITY      {complexity}\n\nHP              {hp}\nATTACK          {attack}\nDEFENCE         {defence}\nSPEED           {speed}\nSTABILITY       {stability}%',
  'splice.risk.none': 'A rabbit remains, disappointingly, a rabbit.',
  'splice.risk.reasonable': 'Reasonable chance of a clean hold. Mutation remains possible.',
  'splice.risk.high': 'The bench recommends fewer genes. The bench has never owned a Fit Pit.',
  'splice.selectGene': 'Select at least one gene.',
  'splice.failed': 'FAILED ({roll} / {chance}). {message}',
  'splice.success': 'VIABLE. {message} Creature logged as {name}.',

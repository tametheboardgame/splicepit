...
export const OPENING_TUTORIAL_PROMPTS: readonly TutorialPromptDefinition[] = [
  ...
  },
  {
    id: 'interact',
    title: 'Interact',
    body: 'Talk to people, inspect things and use nearby equipment.',
  ...
  },
  {
    id: 'confirm-cancel',
    title: 'Choose / Back',
    body: 'Confirm choices or back out without stopping the world around you.',
  ...
  },
  {
    id: 'bag',
    title: 'Bag',
    body: 'Open your Bag when you need to check what you are carrying.',
    actions: [ACTIONS.BAG],
